tharu-humanoid-2026
Building Asimov v1, an open-source bipedal humanoid robot, over summer 2026 in the UK. Full public build log: CAD modifications, firmware, training data, weekly write-ups.
Status: Kit deposit placed (May 2026). Hardware arrives August. Build runs June through September.

About this project
I'm Tharu, a second-year BEng Electrical and Electronic Engineering undergraduate at Swansea University. I didn't get a summer internship this year, so I'm spending the summer building Asimov v1, the open-source humanoid robot Menlo Research released in May 2026.
...
The build
SpecValuePlatformAsimov v1 (Menlo Research, May 2026)Height1.2 mMass35 kgActuators25 ENCOS motors across 5 SKUsStock computeRaspberry Pi 5 + Radxa CM5Target compute upgradeNVIDIA Jetson AGX ThorPerceptionStereolabs ZED 2i, Livox Mid-360, Orbbec Gemini 336LForce/torque sensingBota Systems SensONESimulationMuJoCo, NVIDIA Isaac Sim, Isaac LabPolicy frameworkNVIDIA GR00T N1.7, Hugging Face LeRobot3D printingBambu Lab X1C with PA-CF for custom mounts
Timeline
...
LineCostAsimov v1 kit (with UK VAT and shipping)£13,000Sensors (ZED 2i, Mid-360, Gemini 336L, Bota F/T)£6,800Spare parts (motors die mid build, this isn't optional)£6,000Bambu Lab X1C 3D printer for custom mounts£1,200Workshop tools£2,500Documentation, insurance, customs, makerspace, contingency£3,5003-month project stipend (food and transport; living at parents' so no rent)£5,000Unallocated headroom£1,700Total£40,000
...
Acknowledgements
Built on top of Asimov v1 by Menlo Research. All upstream contributions go back to their repository.
